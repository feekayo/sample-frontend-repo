...
export default function app() {
    ...
    const handleUpload = async e =>
    {
        ...
        try {
            ...
            formdata.append("face", pic.dp, "face.jpg");

            var myHeaders = new Headers();
            myHeaders.append("Authorization", "Bearer " + Session.token, );

            const res = await fetch(Api.faceIdentity, {
                method: 'POST',
                body: formdata,
                headers: {
                  ...
                  <div className="row g-4 ">
                      ...
                      <div className="col-lg-6 mx-auto">
                          ...
                          <div className="bg-gray mb-4 p-4 rounded">
                              <h5 className="m-0">Face Verification</h5>
                              <p className="font-gray fs-6 mb-4">Upload a a passport picture containing your face.</p>
